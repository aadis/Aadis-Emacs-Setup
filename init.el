...
(custom-set-variables
 ...
 '(initial-frame-alist (quote ((vertical-scroll-bars . right) (left . 40) (top . 20) (width . 119) (height . 56) (font . "-apple-Everson Mono-medium-normal-normal-*-12-*-*-*-m-0-iso10646-1"))))
 '(js2-basic-offset 2)
